...
f %>% 
  ...
  geom_halfeyeh(aes(y = 0),
                point_interval = mode_hdi, .width = .95, size = 1/2) +
...
To further demonstrate the similarity of this approach to Kruschke's multilevel Poisson approach, let's compare the model-based cell estimates for each of the combinations of `a` and `b`, by both `fit2` and `fit4`.

...
### Bonus: More Stan resources

Though we won't spend much more time discussing Stan directly in this book, I have a few more resources to share:

* You can find a [*Materials for thoroughly understanding Stan*](https://discourse.mc-stan.org/t/materials-for-thoroughly-understanding-stan/39470) thread on the Stan forums, which has a few useful resources.
* I have released a few blog posts walking out the Stan code underlying a few simple **brms** models, the first post of which you can find [here](https://solomonkurz.netlify.app/blog/2025-07-07-learn-stan-with-brms-part-i/).
* I have a sister companion to my **brms** translation of McElreath's 2nd edition that features **rstan**, which you can find at [https://solomon.quarto.pub/sr2rstan/](https://solomon.quarto.pub/sr2rstan/).

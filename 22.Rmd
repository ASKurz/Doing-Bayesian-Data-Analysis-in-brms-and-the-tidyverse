...
```{r, fig.width = 6, fig.height = 4.25, warning = F, message = F}
b <- plot_spacer()
...
```{r, message = F, echo = F}
# remove the objects
rm(d1, d2, pl, d3, d4, p1, p2, my_arrow, p3, p4, p5, p6, p7, p8, p9, layout, a, c, b, fit22.1, post, nd)
```

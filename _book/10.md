...
```
## [1] "#1F284C" "#2D4472" "#6E6352" "#D9CCAC" "#ECE2C6"
```
...
<img src="10_files/figure-gfm/unnamed-chunk-3-1.png" width="288" style="display: block; margin: auto;" />
...
<img src="10_files/figure-gfm/unnamed-chunk-4-2.png" width="288" style="display: block; margin: auto;" />
...
```
## [1] "#1F284C" "#26365F" "#2D4472" "#4D5362" "#6E6352" "#A3977F" "#D9CCAC"
## [8] "#E2D7B9" "#ECE2C6"
```
...
<img src="10_files/figure-gfm/unnamed-chunk-7-1.png" width="576" style="display: block; margin: auto;" />
...
<img src="10_files/figure-gfm/unnamed-chunk-8-1.png" width="288" style="display: block; margin: auto;" />
...
<img src="10_files/figure-gfm/unnamed-chunk-9-1.png" width="480" style="display: block; margin: auto;" />
...
p3 <-
  ...
  geom_ribbon(fill = alpha(kh[4], .85), size = 0) +
  annotate(geom = "text",
           x = .5, y = .2,
           label = "beta",
           size = 5, color = kh[1]) +
...
<img src="10_files/figure-gfm/unnamed-chunk-10-1.png" width="374.4" style="display: block; margin: auto;" />
...
<img src="10_files/figure-gfm/unnamed-chunk-18-1.png" width="336" style="display: block; margin: auto;" />
...
<img src="10_files/figure-gfm/unnamed-chunk-19-1.png" width="312" style="display: block; margin: auto;" />
...
<img src="10_files/figure-gfm/unnamed-chunk-23-1.png" width="312" style="display: block; margin: auto;" />
...
<img src="10_files/figure-gfm/unnamed-chunk-24-1.png" width="312" style="display: block; margin: auto;" />
...
<img src="10_files/figure-gfm/unnamed-chunk-25-1.png" width="336" style="display: block; margin: auto;" />
...
<img src="10_files/figure-gfm/unnamed-chunk-26-1.png" width="336" style="display: block; margin: auto;" />
...
<img src="10_files/figure-gfm/unnamed-chunk-27-1.png" width="336" style="display: block; margin: auto;" />
...
<img src="10_files/figure-gfm/unnamed-chunk-28-1.png" width="336" style="display: block; margin: auto;" />
...
<img src="10_files/figure-gfm/unnamed-chunk-29-1.png" width="624" style="display: block; margin: auto;" />
...
Both the posterior distributions and the BF indicate $\omega = .75$ is a better representation of the data than $\omega = .25$.
...
<img src="10_files/figure-gfm/unnamed-chunk-34-1.png" width="768" style="display: block; margin: auto;" />
...
<img src="10_files/figure-gfm/unnamed-chunk-50-1.png" width="672" style="display: block; margin: auto;" />
...
<img src="10_files/figure-gfm/unnamed-chunk-51-1.png" width="672" style="display: block; margin: auto;" />
...
<img src="10_files/figure-gfm/unnamed-chunk-52-1.png" width="576" style="display: block; margin: auto;" />
...
<img src="10_files/figure-gfm/unnamed-chunk-56-1.png" width="336" style="display: block; margin: auto;" />
...
tibble(x = seq(from = 1, to = 100, by = 1)) %>% 
  ggplot(aes(x = x, ymin = 0,
             ymax = dgamma(x, 2, 0.1))) +
  geom_ribbon(size = 0, fill = kh[5]) +
  scale_y_continuous(NULL, breaks = NULL,
                     expand = expansion(mult = c(0, 0.05))) +
  scale_x_continuous(expression(italic(p)(nu)), expand = expansion(mult = c(0, 0.01)), limits = c(0, 100))
```

<img src="10_files/figure-gfm/unnamed-chunk-57-1.png" width="384" style="display: block; margin: auto;" />
...
## lp__        -1647.01      0.98 -1649.55 -1646.02
```
...
## lp__        -1590.48      1.24 -1593.61 -1589.07
```
...
<img src="10_files/figure-gfm/unnamed-chunk-60-1.png" width="336" style="display: block; margin: auto;" />
...
<img src="10_files/figure-gfm/unnamed-chunk-61-1.png" width="384" style="display: block; margin: auto;" />

```r
pp_check(fit10.4, nsamples = 50) + coord_cartesian(xlim = c(-10, 10))
```

<img src="10_files/figure-gfm/unnamed-chunk-61-2.png" width="384" style="display: block; margin: auto;" />
...
<img src="10_files/figure-gfm/unnamed-chunk-62-1.png" width="336" style="display: block; margin: auto;" />
...
<img src="10_files/figure-gfm/unnamed-chunk-63-1.png" width="336" style="display: block; margin: auto;" />
...
<img src="10_files/figure-gfm/unnamed-chunk-64-1.png" width="672" style="display: block; margin: auto;" />
...
<img src="10_files/figure-gfm/unnamed-chunk-74-1.png" width="672" style="display: block; margin: auto;" />
...
<img src="10_files/figure-gfm/unnamed-chunk-79-1.png" width="336" style="display: block; margin: auto;" />
...
<img src="10_files/figure-gfm/unnamed-chunk-82-1.png" width="360" style="display: block; margin: auto;" />
...
<img src="10_files/figure-gfm/unnamed-chunk-83-1.png" width="768" style="display: block; margin: auto;" />
...
##  [4] Rcpp_1.0.5           ggforce_0.3.1        patchwork_1.0.1.9000
##  [7] lisa_0.1.1           forcats_0.5.0        stringr_1.4.0       
...
##  [22] knitr_1.28           shinythemes_1.1.2    polyclip_1.10-0     
...
##  [46] glue_1.4.2           reshape2_1.4.4       cellranger_1.1.0    
...
##  [67] parallel_3.6.3       inline_0.3.15        shinystan_2.5.0     
##  [70] yaml_2.2.1           gridExtra_2.3        StanHeaders_2.21.0-1
##  [73] loo_2.3.1            stringi_1.4.6        highr_0.8           
##  [76] dygraphs_1.1.1.6     pkgbuild_1.1.0       rlang_0.4.7         
##  [79] pkgconfig_2.0.3      matrixStats_0.56.0   HDInterval_0.2.0    
##  [82] evaluate_0.14        lattice_0.20-38      rstantools_2.1.1    
##  [85] htmlwidgets_1.5.1    labeling_0.3         processx_3.4.4      
##  [88] tidyselect_1.1.0     plyr_1.8.6           magrittr_1.5        
##  [91] bookdown_0.18        R6_2.4.1             generics_0.0.2      
##  [94] multcomp_1.4-13      DBI_1.1.0            pillar_1.4.6        
##  [97] haven_2.2.0          withr_2.2.0          xts_0.12-0          
## [100] survival_3.1-12      abind_1.4-5          modelr_0.1.6        

...
<img src="13_files/figure-gfm/unnamed-chunk-2-1.png" width="672" style="display: block; margin: auto;" />
...
Here's what $\operatorname{beta}(\theta | 0.65 \cdot (2000 - 2) + 1, (1 - 0.65) \cdot (2000 - 2) + 1)$ looks like.
...
tibble(theta = seq(from = 0, to = 1, by = .001)) %>% 
  ...
  geom_ribbon(size = 0, fill = ce[3]) +
  scale_y_continuous(NULL, breaks = NULL, expand = expansion(mult = c(0, 0.05))) +
  labs(subtitle = expression("Behold our beta"*(1299.7*', '*700.3)*" prior. It's rather peaked"),
       x = expression(theta))
```

<img src="13_files/figure-gfm/unnamed-chunk-3-1.png" width="384" style="display: block; margin: auto;" />
...
<img src="13_files/figure-gfm/unnamed-chunk-11-1.png" width="384" style="display: block; margin: auto;" />
...
<img src="13_files/figure-gfm/unnamed-chunk-17-1.png" width="384" style="display: block; margin: auto;" />
...
<img src="13_files/figure-gfm/unnamed-chunk-21-1.png" width="384" style="display: block; margin: auto;" />
...
<img src="13_files/figure-gfm/unnamed-chunk-22-1.png" width="768" style="display: block; margin: auto;" />
...
<img src="13_files/figure-gfm/unnamed-chunk-25-1.png" width="768" style="display: block; margin: auto;" />
...
## sd(Intercept)     0.23      0.03     0.17     0.29 1.00     2016     2627
## 
## Population-Level Effects: 
##           Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
## Intercept     0.63      0.03     0.57     0.69 1.00     3724     2992
## 
...
<img src="13_files/figure-gfm/unnamed-chunk-40-1.png" width="576" style="display: block; margin: auto;" />
...
##  $ theta: num  0.643 0.572 0.679 0.599 0.536 ...
```
...
<img src="13_files/figure-gfm/unnamed-chunk-42-1.png" width="384" style="display: block; margin: auto;" />
...
##               Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
## sd(Intercept)     0.20      0.13     0.01     0.49 1.00     1363     1507
## 
## Population-Level Effects: 
##           Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
## Intercept     0.67      0.10     0.48     0.88 1.00     3321     2451
## 
## Samples were drawn using sampling(NUTS). For each parameter, Bulk_ESS
## and Tail_ESS are effective sample size measures, and Rhat is the potential
## scale reduction factor on split chains (at convergence, Rhat = 1).
...
## 1     1 <tib…  0.604  0.702     1    0.571    0.751 TRUE           
## 2     1 <tib…  0.604  0.702     2    0.500    0.707 TRUE           
## 3     1 <tib…  0.604  0.702     3    0.614    0.798 TRUE           
## 4     1 <tib…  0.604  0.702     4    0.570    0.751 TRUE           
## 5     1 <tib…  0.604  0.702     5    0.561    0.744 TRUE           
## 6     1 <tib…  0.604  0.702     6    0.621    0.819 TRUE           
...
##               Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
## sd(Intercept)     0.23      0.18     0.01     0.69 1.00     2416     1900
## 
## Population-Level Effects: 
##           Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
## Intercept     0.62      0.23     0.17     1.06 1.00     3044     2808
## 
## Samples were drawn using sampling(NUTS). For each parameter, Bulk_ESS
## and Tail_ESS are effective sample size measures, and Rhat is the potential
## scale reduction factor on split chains (at convergence, Rhat = 1).
...
<img src="13_files/figure-gfm/unnamed-chunk-62-1.png" width="576" style="display: block; margin: auto;" />
...
<img src="13_files/figure-gfm/unnamed-chunk-64-1.png" width="384" style="display: block; margin: auto;" />
...
<img src="13_files/figure-gfm/unnamed-chunk-79-1.png" width="768" style="display: block; margin: auto;" />
...
<img src="13_files/figure-gfm/unnamed-chunk-81-1.png" width="768" style="display: block; margin: auto;" />
...
##  [1] patchwork_1.0.1.9000 tidybayes_2.1.1      brms_2.13.5         
##  [4] Rcpp_1.0.5           fishualize_0.2.0     forcats_0.5.0       
...
##  [28] png_0.1-7            ggdist_2.1.1         shiny_1.5.0         
...
##  [40] htmltools_0.5.0      prettyunits_1.1.1    tools_3.6.3         
...
##  [73] StanHeaders_2.21.0-1 stringi_1.4.6        highr_0.8           
...
##  [85] htmlwidgets_1.5.1    labeling_0.3         tidyselect_1.1.0    
##  [88] processx_3.4.4       plyr_1.8.6           magrittr_1.5        

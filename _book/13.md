...
<img src="13_files/figure-html/unnamed-chunk-2-1.png" width="672" style="display: block; margin: auto;" />
...
<img src="13_files/figure-html/unnamed-chunk-3-1.png" width="384" style="display: block; margin: auto;" />
...
## 1    47     1 0.693 <int [47]> <brmsfit>
## 2    47     1 0.703 <int [47]> <brmsfit>
## 3    47     1 0.676 <int [47]> <brmsfit>
## 4    47     1 0.698 <int [47]> <brmsfit>
## 5    47     1 0.686 <int [47]> <brmsfit>
## 6    47     1 0.695 <int [47]> <brmsfit>
```
...
```
## tibble[,5] [10,000 × 5] (S3: tbl_df/tbl/data.frame)
...
## sd(Intercept)     0.23      0.03     0.17     0.29 1.00     1424     2317
## 
## Population-Level Effects: 
##           Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
## Intercept     0.63      0.03     0.57     0.69 1.00     4305     3375
## 
...
<img src="13_files/figure-html/unnamed-chunk-40-1.png" width="576" style="display: block; margin: auto;" />
...
##  $ theta: num  0.697 0.552 0.629 0.694 0.553 ...
```
...
<img src="13_files/figure-html/unnamed-chunk-42-1.png" width="384" style="display: block; margin: auto;" />
...
##               Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
## sd(Intercept)     0.18      0.12     0.01     0.45 1.00     1268     1588
## 
## Population-Level Effects: 
##           Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
## Intercept     0.76      0.10     0.57     0.97 1.00     3186     2811
## 
## Samples were drawn using sampling(NUTS). For each parameter, Bulk_ESS
## and Tail_ESS are effective sample size measures, and Rhat is the potential
## scale reduction factor on split chains (at convergence, Rhat = 1).
...
##   <int> <list>              <dbl>  <dbl> <dbl>    <dbl>    <dbl> <lgl>          
## 1     1 <tibble[,3] [658 …  0.637  0.735     1    0.602    0.778 TRUE           
## 2     1 <tibble[,3] [658 …  0.637  0.735     2    0.514    0.722 TRUE           
## 3     1 <tibble[,3] [658 …  0.637  0.735     3    0.626    0.799 TRUE           
## 4     1 <tibble[,3] [658 …  0.637  0.735     4    0.618    0.794 TRUE           
## 5     1 <tibble[,3] [658 …  0.637  0.735     5    0.633    0.803 TRUE           
## 6     1 <tibble[,3] [658 …  0.637  0.735     6    0.638    0.820 TRUE           
...
##               Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
## sd(Intercept)     0.22      0.18     0.01     0.69 1.00     2261     1693
## 
## Population-Level Effects: 
##           Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
## Intercept     0.62      0.23     0.18     1.08 1.00     3754     2689
## 
## Samples were drawn using sampling(NUTS). For each parameter, Bulk_ESS
## and Tail_ESS are effective sample size measures, and Rhat is the potential
## scale reduction factor on split chains (at convergence, Rhat = 1).
...
<img src="13_files/figure-html/unnamed-chunk-62-1.png" width="576" style="display: block; margin: auto;" />
...
<img src="13_files/figure-html/unnamed-chunk-64-1.png" width="384" style="display: block; margin: auto;" />
...
<img src="13_files/figure-html/unnamed-chunk-79-1.png" width="768" style="display: block; margin: auto;" />
...
<img src="13_files/figure-html/unnamed-chunk-81-1.png" width="768" style="display: block; margin: auto;" />
...
##  [1] patchwork_1.1.1  tidybayes_2.3.1  brms_2.15.0      Rcpp_1.0.6      
##  [5] fishualize_0.2.2 forcats_0.5.1    stringr_1.4.0    dplyr_1.0.5     
...
##  [88] png_0.1-7            reprex_0.3.0         statmod_1.4.35      

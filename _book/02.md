...
We're about ready for the model. We will fit it with HMC via the [**brms** package](https://CRAN.R-project.org/package=brms). 
...
For Figure 2.5.b., we'll use the handy `stat_histintervalh()` function from the [**tidybayes** package](http://mjskay.github.io/tidybayes) [@R-tidybayes] to mark off the mode and 95% HDIs underneath a histogram.
...
##  [7] purrr_0.3.4          readr_1.3.1          tidyr_1.0.2         
...
##  [31] cli_2.0.2            later_1.0.0          prettyunits_1.1.1   
##  [34] htmltools_0.4.0      tools_3.6.3          igraph_1.2.5        

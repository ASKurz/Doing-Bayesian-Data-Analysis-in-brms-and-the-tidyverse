...
## Population-Level Effects: 
##                      Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
## conditionBach            0.02      0.10    -0.18     0.21 1.00     8499     6132
## conditionBeethoven       0.01      0.10    -0.18     0.21 1.00     8569     6072
## conditionDasKruschke    -0.61      0.10    -0.81    -0.41 1.00     8222     5958
## conditionMozart          0.05      0.10    -0.14     0.25 1.00     7788     5932
## 
## Samples were drawn using sampling(NUTS). For each parameter, Eff.Sample 
## is a crude measure of effective sample size, and Rhat is the potential 
## scale reduction factor on split chains (at convergence, Rhat = 1).
...
## Observations: 8,000
## Variables: 6
## $ `theta[1]-theta[2]` <dbl> -0.1552512, -0.1908361, -0.1564093, -0.1667210, -0.1991768, -0.192245…
## $ `theta[1]-theta[3]` <dbl> -0.2016419, -0.1952225, -0.1265281, -0.1846442, -0.2403447, -0.136256…
## $ `theta[1]-theta[4]` <dbl> -0.13750613, -0.18196275, -0.12657267, -0.17766114, -0.15196070, -0.1…
## $ `theta[2]-theta[3]` <dbl> -0.046390704, -0.004386396, 0.029881199, -0.017923136, -0.041167936, …
## $ `theta[2]-theta[4]` <dbl> 0.0177451072, 0.0088733060, 0.0298366064, -0.0109401118, 0.0472160583…
## $ `theta[3]-theta[4]` <dbl> 6.413581e-02, 1.325970e-02, -4.459254e-05, 6.983025e-03, 8.838399e-02…
```
...
##   key                value .lower .upper .width .point .interval
##   <chr>              <dbl>  <dbl>  <dbl>  <dbl> <chr>  <chr>    
## 1 theta[1]-theta[2] -0.157 -0.228 -0.095   0.95 mode   hdi      
## 2 theta[1]-theta[3] -0.156 -0.216 -0.085   0.95 mode   hdi      
## 3 theta[1]-theta[4] -0.156 -0.218 -0.082   0.95 mode   hdi      
## 4 theta[2]-theta[3]  0.001 -0.057  0.08    0.95 mode   hdi      
## 5 theta[2]-theta[4]  0.004 -0.059  0.077   0.95 mode   hdi      
## 6 theta[3]-theta[4] -0.007 -0.065  0.073   0.95 mode   hdi
```
...
## 2 theta[1]-theta[3] 0    
## 3 theta[1]-theta[4] 0    
## 4 theta[2]-theta[3] 0.582
## 5 theta[2]-theta[4] 0.607
## 6 theta[3]-theta[4] 0.522
```
...
## fit3  -11.9       5.5  -184.4      6.9         1.1    0.2    368.7   13.8
```
...
## 1 (inv_logit_scaled... < 0    -0.15      0.03    -0.21    -0.09        Inf         1    *
## ---
...
## Hypothesis Tests for class b:
##                 Hypothesis Estimate Est.Error CI.Lower CI.Upper Evid.Ratio Post.Prob Star
## 1 (inv_logit_scaled... > 0     0.01      0.04    -0.05     0.07       1.39      0.58     
## ---
## 'CI': 90%-CI for one-sided and 95%-CI for two-sided hypotheses.
## '*': For one-sided hypotheses, the posterior probability exceeds 95%;
## for two-sided hypotheses, the value tested against lies outside the 95%-CI.
...
##  [1] patchwork_1.0.0 tidybayes_1.1.0 brms_2.11.0     Rcpp_1.0.3      forcats_0.4.0   stringr_1.4.0  
...
##  [19] knitr_1.26                shinythemes_1.1.2         zeallot_0.1.0            
##  [22] bayesplot_1.7.1           jsonlite_1.6              broom_0.5.3              
...
##  [64] shinystan_2.5.0           yaml_2.2.0                gridExtra_2.3            
##  [67] loo_2.2.0                 StanHeaders_2.19.0        stringi_1.4.5            
##  [70] dygraphs_1.1.1.6          pkgbuild_1.0.6            rlang_0.4.2              
##  [73] pkgconfig_2.0.3           matrixStats_0.55.0        HDInterval_0.2.0         
##  [76] evaluate_0.14             lattice_0.20-38           rstantools_2.0.0         
##  [79] htmlwidgets_1.5.1         labeling_0.3              tidyselect_0.2.5         
##  [82] processx_3.4.1            plyr_1.8.5                magrittr_1.5             
##  [85] R6_2.4.1                  generics_0.0.2            DBI_1.1.0                
##  [88] pillar_1.4.3              haven_2.2.0               withr_2.1.2              
##  [91] xts_0.11-2                abind_1.4-5               modelr_0.1.5             
##  [94] crayon_1.3.4              arrayhelpers_1.0-20160527 utf8_1.1.4               
##  [97] rmarkdown_2.0             grid_3.6.2                readxl_1.3.1             
## [100] callr_3.4.0               threejs_0.3.1             reprex_0.3.0             
## [103] digest_0.6.23             xtable_1.8-4              httpuv_1.5.2             
## [106] stats4_3.6.2              munsell_0.5.0             shinyjs_1.1
```

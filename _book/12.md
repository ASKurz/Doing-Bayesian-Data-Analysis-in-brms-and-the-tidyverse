...
<img src="12_files/figure-html/unnamed-chunk-7-1.png" width="576" style="display: block; margin: auto;" />
...
## Rows: 9,000
## Columns: 3
## $ `ShinSoo Choo`                 <dbl> 0.2658494, 0.2753031, 0.2726212, 0.2838544, 0.2728334, 0.28…
## $ `Ichiro Suzuki`                <dbl> 0.2673007, 0.2927712, 0.2600574, 0.2916322, 0.2634055, 0.29…
## $ `ShinSoo Choo - Ichiro Suzuki` <dbl> -0.0014513047, -0.0174680406, 0.0125638154, -0.0077778581, …
```
...
<img src="12_files/figure-html/unnamed-chunk-20-1.png" width="384" style="display: block; margin: auto;" />
...
<img src="12_files/figure-html/unnamed-chunk-33-1.png" width="576" style="display: block; margin: auto;" />
...
## [1,] -0.9706135 0.07657279 -1.119183 -0.8212889
## [2,] -0.9672420 0.07443256 -1.117382 -0.8192201
```
...
## 1 V1    -0.971  -1.12 -0.821   0.95 mean   hdi      
## 2 V2    -0.967  -1.11 -0.815   0.95 mean   hdi
```
...
<img src="12_files/figure-html/unnamed-chunk-38-1.png" width="432" style="display: block; margin: auto;" />
...
<img src="12_files/figure-html/unnamed-chunk-41-1.png" width="432" style="display: block; margin: auto;" />
...
<img src="12_files/figure-html/unnamed-chunk-48-1.png" width="432" style="display: block; margin: auto;" />
...
<img src="12_files/figure-html/unnamed-chunk-51-1.png" width="432" style="display: block; margin: auto;" />
...
Here's how you'd get the actual exact and HDI summaries.
...
Disclaimer: I am not a fan of hypothesis testing within the Bayesian framework. Outside of pedagogical material, I do not use these methods. However, it'd seem negligent not to at least mention the convenience function designed for that purpose in **brms**: the `hypothesis()` function. From the `hypothesis.brmsfit` section in the [**brms** reference manual](https://CRAN.R-project.org/package=brms/brms.pdf) [@brms2021RM, p. 99] we read:
...
##  [1] patchwork_1.1.1  tidybayes_2.3.1  brms_2.15.0      Rcpp_1.0.6       cowplot_1.1.1   
##  [6] forcats_0.5.1    stringr_1.4.0    dplyr_1.0.5      purrr_0.3.4      readr_1.4.0     
## [11] tidyr_1.1.3      tibble_3.1.1     ggplot2_3.3.3    tidyverse_1.3.0  fishualize_0.2.2
## 
...
##  [61] labeling_0.4.2       tidyselect_1.1.0     rlang_0.4.11         reshape2_1.4.4      
##  [65] later_1.2.0          munsell_0.5.0        cellranger_1.1.0     tools_4.0.4         
##  [69] cli_2.5.0            generics_0.1.0       broom_0.7.5          ggridges_0.5.3      
##  [73] evaluate_0.14        fastmap_1.1.0        processx_3.5.2       knitr_1.31          
##  [77] fs_1.5.0             nlme_3.1-152         mime_0.10            projpred_2.0.2      
##  [81] xml2_1.3.2           compiler_4.0.4       bayesplot_1.8.0      shinythemes_1.1.2   
##  [85] rstudioapi_0.13      curl_4.3             gamm4_0.2-6          png_0.1-7           
...
## [105] bridgesampling_1.0-0 estimability_1.3     httpuv_1.6.0         R6_2.5.0            
## [109] bookdown_0.21        promises_1.2.0.1     gridExtra_2.3        codetools_0.2-18    
...
## [121] mgcv_1.8-33          parallel_4.0.4       hms_0.5.3            grid_4.0.4          
## [125] coda_0.19-4          minqa_1.2.4          rmarkdown_2.7        shiny_1.6.0         

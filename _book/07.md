...
Our `hdi_of_icdf()` function will compute the analytic 95% HDIs for the distribution under consideration in Figure 7.1, $\operatorname{beta} (\theta | 15, 7)$.
...
<img src="07_files/figure-gfm/unnamed-chunk-6-1.png" width="288" style="display: block; margin: auto;" />
...
<img src="07_files/figure-gfm/unnamed-chunk-8-1.png" width="960" style="display: block; margin: auto;" />
...
<img src="07_files/figure-gfm/sim-1.png" width="768" style="display: block; margin: auto;" />
...
<img src="07_files/figure-gfm/unnamed-chunk-11-1.png" width="576" style="display: block; margin: auto;" />
...
<img src="07_files/figure-gfm/unnamed-chunk-12-1.png" width="576" style="display: block; margin: auto;" />
...
<img src="07_files/figure-gfm/unnamed-chunk-13-1.png" width="576" style="display: block; margin: auto;" />
...
p %>% 
  as_tibble_col() %>% 
  mutate(facet = str_c("italic(t)==", 1:15)) %>% 
  unnest(value) %>% 
  bind_rows(
    tibble(position = 1:nslots, 
           prob     = p_target, 
  ...
  mutate(facet = factor(facet, levels = c(str_c("italic(t)==", 1:15), "target"))) %>% 
  
  # plot!
  ggplot(aes(x = position, y = prob, fill = facet == "target")) +
  geom_col(width = .2) +
  scale_fill_manual(values = c("grey50", "goldenrod2")) +
  scale_x_continuous(expression(theta), breaks = 1:7) +
...
<img src="07_files/figure-gfm/unnamed-chunk-15-1.png" width="960" style="display: block; margin: auto;" />
...
<img src="07_files/figure-gfm/unnamed-chunk-19-1.png" width="480" style="display: block; margin: auto;" />
...
<img src="07_files/figure-gfm/unnamed-chunk-22-1.png" width="960" style="display: block; margin: auto;" />
...
<img src="07_files/figure-gfm/unnamed-chunk-23-1.png" width="960" style="display: block; margin: auto;" />
...
<img src="07_files/figure-gfm/unnamed-chunk-24-1.png" width="960" style="display: block; margin: auto;" />
...
<img src="07_files/figure-gfm/betas-1.png" width="672" style="display: block; margin: auto;" />
...
<img src="07_files/figure-gfm/unnamed-chunk-25-1.png" width="672" style="display: block; margin: auto;" />
...
<img src="07_files/figure-gfm/unnamed-chunk-26-1.png" width="672" style="display: block; margin: auto;" />
...
<img src="07_files/figure-gfm/unnamed-chunk-28-1.png" width="528" style="display: block; margin: auto;" />
...
<img src="07_files/figure-gfm/unnamed-chunk-29-1.png" width="432" style="display: block; margin: auto;" />
...
<img src="07_files/figure-gfm/unnamed-chunk-36-1.png" width="672" style="display: block; margin: auto;" />
...
<img src="07_files/figure-gfm/unnamed-chunk-37-1.png" width="384" style="display: block; margin: auto;" />
...
<img src="07_files/figure-gfm/unnamed-chunk-38-1.png" width="312" style="display: block; margin: auto;" />
...
## 1         0.3109545 -0.07194696 0.6407353   0.95   mode       hdi
```
...
<img src="07_files/figure-gfm/unnamed-chunk-41-1.png" width="768" style="display: block; margin: auto;" />
...
<img src="07_files/figure-gfm/unnamed-chunk-44-1.png" width="576" style="display: block; margin: auto;" />

As an alternative, we can also extract the warmup draws from a `brm()` fit with the [**ggmcmc** package](https://cran.rstudio.com/package=ggmcmc) [@R-ggmcmc; @Fernandez2016ggmcmc]. 
...
<img src="07_files/figure-gfm/unnamed-chunk-46-1.png" width="576" style="display: block; margin: auto;" />
...
<img src="07_files/figure-gfm/unnamed-chunk-47-1.png" width="384" style="display: block; margin: auto;" />
...
<img src="07_files/figure-gfm/unnamed-chunk-48-1.png" width="384" style="display: block; margin: auto;" />
...
<img src="07_files/figure-gfm/unnamed-chunk-49-1.png" width="384" style="display: block; margin: auto;" />
...
<img src="07_files/figure-gfm/unnamed-chunk-50-1.png" width="576" style="display: block; margin: auto;" />
...
<img src="07_files/figure-gfm/unnamed-chunk-51-1.png" width="384" style="display: block; margin: auto;" />
...
<img src="07_files/figure-gfm/unnamed-chunk-52-1.png" width="384" style="display: block; margin: auto;" />
...
<img src="07_files/figure-gfm/unnamed-chunk-54-1.png" width="384" style="display: block; margin: auto;" />
...
<img src="07_files/figure-gfm/unnamed-chunk-56-1.png" width="480" style="display: block; margin: auto;" />
...
<img src="07_files/figure-gfm/unnamed-chunk-58-1.png" width="960" style="display: block; margin: auto;" />
...
<img src="07_files/figure-gfm/unnamed-chunk-59-1.png" width="960" style="display: block; margin: auto;" />
...
<img src="07_files/figure-gfm/unnamed-chunk-61-1.png" width="384" style="display: block; margin: auto;" />
...
Anyway, I'm not quite sure how to reproduce Kruschke's MCMC ESS simulation studies. If you've got it figured out, please share your code in my [GitHub issue #15](https://github.com/ASKurz/Doing-Bayesian-Data-Analysis-in-brms-and-the-tidyverse/issues/15).
...
```
## Inference for Stan model: 5351a09d3d5d34fa50f6376e2c847de5.
...
## 
## Samples were drawn using NUTS(diag_e) at Tue Feb  4 19:51:28 2020.
...
##  [1] psych_1.9.12.31      patchwork_1.0.0      ggmcmc_1.4.1         bayesplot_1.7.1     
##  [5] brms_2.12.0          Rcpp_1.0.4.6         tidybayes_2.0.3.9000 forcats_0.5.0       
...
##  [17] splines_3.6.3        bridgesampling_1.0-0 mnormt_1.5-6         knitr_1.28          
##  [21] shinythemes_1.1.2    jsonlite_1.6.1       broom_0.5.5          dbplyr_1.4.2        
...
##  [41] reshape2_1.4.4       cellranger_1.1.0     vctrs_0.3.0          nlme_3.1-144        
##  [45] crosstalk_1.1.0.1    xfun_0.13            ps_1.3.3             rvest_0.3.5         
##  [49] mime_0.9             miniUI_0.1.1.1       lifecycle_0.2.0      gtools_3.8.2        
##  [53] MASS_7.3-51.5        zoo_1.8-7            scales_1.1.1         colourpicker_1.0    
...
##  [65] gridExtra_2.3        StanHeaders_2.21.0-1 loo_2.2.0            reshape_0.8.8       
##  [69] stringi_1.4.6        dygraphs_1.1.1.6     pkgbuild_1.0.8       rlang_0.4.6         
##  [73] pkgconfig_2.0.3      matrixStats_0.56.0   HDInterval_0.2.0     evaluate_0.14       
##  [77] lattice_0.20-38      rstantools_2.0.0     htmlwidgets_1.5.1    labeling_0.3        
##  [81] processx_3.4.2       tidyselect_1.0.0     GGally_1.5.0         plyr_1.8.6          
##  [85] magrittr_1.5         bookdown_0.18        R6_2.4.1             generics_0.0.2      
##  [89] DBI_1.1.0            mgcv_1.8-31          pillar_1.4.4         haven_2.2.0         
##  [93] withr_2.2.0          xts_0.12-0           abind_1.4-5          modelr_0.1.6        
##  [97] crayon_1.3.4         arrayhelpers_1.1-0   utf8_1.1.4           rmarkdown_2.1       
## [101] grid_3.6.3           readxl_1.3.1         callr_3.4.3          threejs_0.3.3       
## [105] reprex_0.3.0         digest_0.6.25        xtable_1.8-4         httpuv_1.5.2        
## [109] stats4_3.6.3         munsell_0.5.0        viridisLite_0.3.0    shinyjs_1.1
```

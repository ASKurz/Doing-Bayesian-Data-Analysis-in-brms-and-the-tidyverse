...
rm(h_counter, coins, n, z, n_choose_z, flips, highest_n, bernoulli_likelihood, trial_data, d_nail, d_coin, p1, p2, p3, p4, hdi_of_icdf, theta, alpha_pc, c, z_maker, n_iter)
```

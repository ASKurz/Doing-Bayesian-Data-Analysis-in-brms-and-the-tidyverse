...
For a more robust model comparison, we might follow the `kfold()` suggestion in the warning. However, be warned: The `kfold()` function entails refitting the model `K` times. `fit20.1` took about an hour to fit and `fit20.2` took about 8 hours. Proceed with caution. 
...
```{r, message = F, echo = F}
# remove the objects
rm(grand_mean, deflection_1, deflection_2, nonadditive_component, d, p, p1, p2, p3, gamma_a_b_from_omega_sigma, my_data, mean_y, sd_y, omega, sigma, s_r, stanvars, fit20.1, n_draw, f, n_iter, post, nd, brief_col_names, f1, text, f2, fit20.2, fit20.3, col_names, fit20.4)
```

...
```{r, message = F, echo = F}
# remove the objects
rm(grand_mean, deflection_1, deflection_2, nonadditive_component, d, bd, p, p1, p2, p3, gamma_a_b_from_omega_sigma, my_data, mean_y, sd_y, omega, sigma, s_r, stanvars, n_draw, f, n_iter, post, stat_beedrill, nd, brief_col_names, f1, text, f2, fit20.3, col_names, fit20.4)
```

...
d, d_text, d_arrow, HtWtDataGenerator
```{r}
...
d, d_text, d_arrow, HtWtDataGenerator, fit
...
d, d_text, d_arrow, HtWtDataGenerator, fit, post, n_lines, nd
...
```{r, eval = F, echo = F}
# remove our objects
rm(d, d_text, d_arrow, HtWtDataGenerator, fit, post, n_lines, nd)
```

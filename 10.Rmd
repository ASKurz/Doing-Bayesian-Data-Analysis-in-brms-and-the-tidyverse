...
```{r, echo = F}
# remove our objects
rm(d, kh, length, p_d, p_d_1, p_d_2, odds, p1, p2, bernoulli_likelihood, n, z, trial_data, omega, kappa, stanvars, fit10.1, theta, mean_theta, sd_theta, a_post, b_post, one_over_pd, fit10.2, mw, nd, pp_a, fit10.3, fit10.4, my_data, fit9.2, fit10.5, fit10.6, hdi_of_icdf, hdi_of_qbeta, fit10.7, fit10.8, p3)
```

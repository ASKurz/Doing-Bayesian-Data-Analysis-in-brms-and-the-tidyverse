...
```{r, echo = F}
# remove the objects
rm(n_draw, d, curves, HtWtDataGenerator, standardize, fit17.1, stanvars, fit17.2, post, make_beta_0, make_beta_1, sd_x, sd_y, m_x, m_y, n_lines, rope, beta_0_sigma, beta_1_sigma, fit17.3, p1, p2, nd, my_data, fit17.4, p3, p4, c, f, fit17.5, make_beta_2)
```

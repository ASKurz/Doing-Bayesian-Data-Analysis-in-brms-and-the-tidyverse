...
d %>% 
  ...
  geom_abline(data = draws_df %>% slice(1:n_lines),
...
mcmc_acf(as_draws_array(fit17.1), pars = c("b_Intercept", "b_height_z", "sigma", "nu"), lags = 10)
mcmc_acf(as_draws_array(fit17.3), pars = c("b_Intercept", "b_height", "sigma", "nu"), lags = 10)
```
...
```{r, echo = F}
# remove the objects
rm(n_draw, d, curves, beyonce_palettes, bp, p1, p2, my_arrow, p3, p4, p5, p6, p7, p8, p9, p10, layout, HtWtDataGenerator, standardize, fit17.1, stanvars, fit17.2, draws_df, make_beta_0, make_beta_1, sd_x, sd_y, m_x, m_y, n_lines, rope, text, beta_0_sigma, beta_1_sigma, fit17.3, nd, my_data, p11, p12, p13, p14, p15, fit17.4, c, f, fit17.5, make_beta_2)
```

...
```{r 17_fit1_fit2, cache = T, message = F, warning = F}
fit1 <-
  brm(data = d,
      family = student,
      weight_z ~ 1 + height_z,
...
```{r 17_fit3, cache = T, message = F, warning = F}
fit3 <-
  brm(data = d,
      family = student,
      weight ~ 1 + height,
...
```{r 17_fit4, cache = T, message = F, warning = F}
fit4 <-
  brm(data = my_data,
      family = student,
...
```{r 17_fit5, cache = T, message = F, warning = F}
fit5 <-
  brm(data = my_data,
      family = student,
...
```{r, echo = F}
# remove the objects
rm(n_draw, d, curves, HtWtDataGenerator, standardize, fit1, stanvars, fit2, post, make_beta_0, make_beta_1, sd_x, sd_y, m_x, m_y, n_lines, rope, beta_0_sigma, beta_1_sigma, fit3, nd, my_data, fit4, c, f, fit5, make_beta_2)
```

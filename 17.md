...
```
    ...
    ## Intercept    -0.04      0.05    -0.15     0.07       2846 1.00
    ## height_z      0.50      0.05     0.40     0.59       3561 1.00
    ## 
    ## Family Specific Parameters: 
    ##       Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
    ## sigma     0.81      0.05     0.70     0.90       2117 1.00
    ## nu       22.39     21.35     5.29    81.29       2155 1.00
    ## 
...
```
    ...
    ## Population-Level Effects: 
    ##           Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
    ## Intercept     0.12      0.21    -0.29     0.52       3005 1.00
    ## height_z      0.66      0.18     0.30     1.04       4000 1.00
    ## 
    ## Family Specific Parameters: 
    ##       Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
    ## sigma     1.05      0.17     0.74     1.40       2762 1.00
    ## nu       32.78     29.33     3.00   112.06       4000 1.00
    ## 
    ## Samples were drawn using sampling(NUTS). For each parameter, Eff.Sample 
    ## is a crude measure of effective sample size, and Rhat is the potential 
    ## scale reduction factor on split chains (at convergence, Rhat = 1).
...
```
    ...
    ## 1  0.012011686  0.4424261 0.8074583 10.745084 -394.0936
    ## 2 -0.006278592  0.5977632 0.8804257 55.386724 -396.1464
    ## 3 -0.061657421  0.4079352 0.7338578  6.905096 -394.9969
    ## 4 -0.105859736  0.5398209 0.7856617 11.184138 -393.6731
    ## 5 -0.005151265  0.4521955 0.8130788  7.233486 -395.2764
    ## 6 -0.053584530  0.5269616 0.8307815 20.953660 -393.1211
...
```
    ...
    ## Observations: 4,000
    ## Variables: 7
    ## $ b_Intercept <dbl> 0.012011686, -0.006278592, -0.061657421, -0.105859...
    ## $ b_height_z  <dbl> 0.4424261, 0.5977632, 0.4079352, 0.5398209, 0.4521...
    ## $ sigma       <dbl> 0.8074583, 0.8804257, 0.7338578, 0.7856617, 0.8130...
    ## $ nu          <dbl> 10.745084, 55.386724, 6.905096, 11.184138, 7.23348...
    ## $ lp__        <dbl> -394.0936, -396.1464, -394.9969, -393.6731, -395.2...
    ## $ b_0         <dbl> -84.44603, -169.96052, -67.95495, -141.48017, -90....
    ## $ b_1         <dbl> 3.634148, 4.910108, 3.350835, 4.434163, 3.714396, ...
...
```
    ...
    ## Observations: 4,000
    ## Variables: 7
    ## $ b_Intercept <dbl> -0.146848332, 0.082157461, -0.128358692, 0.3103208...
    ## $ b_height_z  <dbl> 0.8185467, 0.5144316, 0.7912718, 0.6704348, 0.5961...
    ## $ sigma       <dbl> 1.3228018, 0.9237155, 1.1808736, 0.8963120, 0.9962...
    ## $ nu          <dbl> 11.864577, 65.104440, 4.724165, 124.034095, 35.522...
    ## $ lp__        <dbl> -58.23407, -56.40980, -58.52852, -57.89262, -55.37...
    ## $ b_0         <dbl> -295.18362, -121.56054, -279.67788, -199.52381, -1...
    ## $ b_1         <dbl> 6.723654, 4.225611, 6.499615, 5.507043, 4.896476, ...
...
```
    ...
    ## Population-Level Effects: 
    ##           Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
    ## Intercept  -114.98     25.64  -164.01   -64.87       4000 1.00
    ## height        4.07      0.38     3.32     4.81       4000 1.00
    ## 
    ## Family Specific Parameters: 
    ##       Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
    ## sigma    25.88      1.64    22.56    29.02       2189 1.00
    ## nu       21.79     20.42     5.54    79.03       1951 1.00
    ## 
    ## Samples were drawn using sampling(NUTS). For each parameter, Eff.Sample 
    ## is a crude measure of effective sample size, and Rhat is the potential 
    ## scale reduction factor on split chains (at convergence, Rhat = 1).
...
```
    ...
    ##                     Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
    ## sd(Intercept)           0.75      0.08     0.61     0.92        891 1.00
    ## sd(FamilySize_z)        0.07      0.04     0.00     0.16       1019 1.00
    ## sd(IFamilySize_zE2)     0.05      0.04     0.00     0.13        714 1.00
    ## 
    ## Population-Level Effects: 
    ##                 Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
    ## Intercept           0.39      0.12     0.17     0.62        527 1.00
    ## FamilySize_z        0.12      0.05     0.03     0.22       3488 1.00
    ## IFamilySize_zE2    -0.44      0.04    -0.52    -0.36       4000 1.00
    ## 
    ## Family Specific Parameters: 
    ##       Estimate Est.Error l-95% CI u-95% CI Eff.Sample Rhat
    ## sigma     0.05      0.04     0.00     0.13       2230 1.00
    ## nu       68.73     36.71    21.46   158.34       4000 1.00
    ## 
    ## Samples were drawn using sampling(NUTS). For each parameter, Eff.Sample 
    ## is a crude measure of effective sample size, and Rhat is the potential 
    ## scale reduction factor on split chains (at convergence, Rhat = 1).
...
```
    ...
    ## 1          1 27173. 18031. -1862.     1       43342.
    ## 2          1 19942. 22036. -2250.     2       39727.
    ## 3          1 21592. 21724. -2342.     3       40974.
    ## 4          1 24003. 19432. -2010.     4       41425.
    ## 5          1 19541. 19758. -1956.     5       37343.
    ## 6          1 21910. 20480. -2184.     6       40206.
...
```
    ...
    ## 1 Alabama    -0.219       0.125           -0.401 17726. 19305. -2025.
    ## 2 Alabama    -0.367       0.0734          -0.459 11600. 21498. -2318.
    ## 3 Alabama    -0.126      -0.110           -0.590  8932. 25854. -2978.
    ## 4 Alabama    -0.306       0.154           -0.275 28227. 13817. -1388.
    ## 5 Alabama     0.109       0.299           -0.479  7880. 24331. -2417.
    ## 6 Alabama    -0.354      -0.0313          -0.431 18706. 19330. -2178.
...
```
    ...
    ## 1          1 Alabama 17726. 19305. -2025.     1       35006.
    ## 2          1 Alabama 11600. 21498. -2318.     2       30780.
    ## 3          1 Alabama  8932. 25854. -2978.     3       31807.
    ## 4          1 Alabama 28227. 13817. -1388.     4       40656.
    ## 5          1 Alabama  7880. 24331. -2417.     5       29795.
    ## 6          1 Alabama 18706. 19330. -2178.     6       35858.
...
```
    ...
    ##   <chr>   <dbl>   <dbl>   <dbl>
    ## 1 b_1    21142.  17852.  24040.
    ## 2 b_2    -2226.  -2602.  -1801.

...
```
    ...
    ##   <chr>              <dbl>    <dbl>     <dbl> <dbl>
    ## 1 theta_1 - theta_2 -0.098   -0.165    -0.03   0.95
    ## 2 theta_1 - theta_3 -0.088   -0.16     -0.026  0.95
    ## 3 theta_1 - theta_4 -0.149   -0.224    -0.088  0.95
    ## 4 theta_2 - theta_3  0.002   -0.064     0.073  0.95
    ## 5 theta_2 - theta_4 -0.056   -0.125     0.014  0.95
    ## 6 theta_3 - theta_4 -0.062   -0.13      0.007  0.95
...
```
    ...
    ##  [1] gridExtra_2.3         tidybayes_0.12.1.9000 brms_2.4.0           
    ##  [4] Rcpp_0.12.18          bindrcpp_0.2.2        forcats_0.3.0        

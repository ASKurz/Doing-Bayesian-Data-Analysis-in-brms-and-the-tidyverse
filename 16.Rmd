...
It's easy to use Student's $t$ in brms. Make sure to specify `family = student`. Be default, brms already sets the lower bound for $\nu$ to 1, so there's no need to worry about shifting the exponential prior. Also, Stan will bark if you try to enter the `1/30` into the exponential prior:

> DIAGNOSTIC(S) FROM PARSER:
Warning: integer division implicitly rounds to integer. Found int division: 1 / 30

...
set.seed(16)
p1 <-
  pp_check(fit16.1, nsamples = 63, type = "ecdf_overlay") + 
...
p2 <-
  pp_check(fit16.2, nsamples = 63, type = "ecdf_overlay") + 
...
rm(sequence_length, d, my_data, mean_y, sd_y, stanvars, fit16.1, post, rope, n_lines, t_maker, n_draws, mu, p1, p2, fit16.2, fit16.3)
```

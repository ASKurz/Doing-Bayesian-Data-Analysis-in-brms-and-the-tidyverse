...
```{r 16_fit1, cache = T, message = F, warning = F}
fit1 <-
  brm(data = my_data,
      family = gaussian,
      Score ~ 1,
...
```{r 16_fit2, cache = T, message = F, warning = F}
fit2 <-
  brm(data = my_data,
      family = student,
      Score ~ 1,
...
# this model is too large to cache. saving the fit this way saves enough memory

# save("fit3", file = "fits/16_fit3.rda")
# rm(fit3)

load("fits/16_fit3.rda")
```

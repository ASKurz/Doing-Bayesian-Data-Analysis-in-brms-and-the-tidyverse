...
You can learn more about how to use **patchwork** [here](https://cran.r-project.org/web/packages/patchwork/vignettes/patchwork.html). Plus we’ll have man more opportunities to practice as we progress through the chapters.

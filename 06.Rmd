...
rm(Bernoulli_likelihood, betaABfromMeanKappa, betaABfromModeKappa, betaABfromMeanSD, beta_param, hdi_of_icdf, N, z, a, b, proportion_heads, prior_mean, posterior_mean, trial_data, d, line_tibble, text_tibble, get_hdi, theta, p_theta, BernGrid, plot_1, plot_2, plot_3)
```

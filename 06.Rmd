...
```{r, echo = F, eval = F}
rm(bernoulli_likelihood, betaABfromMeanKappa, betaABfromModeKappa, betaABfromMeanSD, beta_param, hdi_of_icdf, n, z, a, b, proportion_heads, prior_mean, posterior_mean, trial_data, d, line, text, get_hdi, theta, p_theta, BernGrid, p1, p2, p3)
```

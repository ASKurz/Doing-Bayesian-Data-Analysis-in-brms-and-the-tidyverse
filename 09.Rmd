...
Do note that, unlike Kruschke's Figure 9.17, our subplots are all based on $\theata$ rather than $\omega$. This is because of our use of a hierarchical aggregated binomial, rather than the approach Kruschke took. Even so, look how similar the results are.

...
p9 <-
  ...
  ggplot(aes(x = x, y = y, label = label)) +
  geom_text(size = 10, parse = T, family = "Times") +
  geom_segment(x = .5, xend = .5,
               y = 1, yend = .4,
               arrow = my_arrow) +
  xlim(0, 1) +

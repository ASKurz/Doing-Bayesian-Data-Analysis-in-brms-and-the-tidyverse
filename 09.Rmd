...
tibble(shape = c(.01, 1.56, 1, 6.25),
  ...
  mutate(label = str_c("shape = ", shape, ", rate = ", rate, 
                       "\nmean = ", mean, ", sd = ", ifelse(sd > 40 & sd < 41, round(sd, 4), sd))) %>% 
...
```{r, echo = F}
# remove our objects
rm(beta_by_k, alpha, beta, make_prior, parameter_space, d, geom_2dd, geom_marginal, text, bernoulli_likelihood, n, z, trial_data, trial_data_1, trial_data_2, p11, p12, p13, p21, p22, p23, p31, p32, p33, p41, p42, p43, p51, p52, p53, length, gamma_s_and_r_from_mean_sd, gamma_s_and_r_from_mode_sd, gamma_param, my_data, fit9.1, post, post_small, p1, p2, p3, labels, sigmas, r_norm, fit9.1_prior, prior, prior_samples, omega, kappa1, kappa2, stop_time_bernoulli, start_time_bernoulli, stop_time_binomial, start_time_binomial, fit9.2, make_histogram, make_point, p4, coef_primary_position, coef_small, name_list, nd, fitted_players, fitted_positions)
```

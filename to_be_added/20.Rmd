...
# As of 11-12-19, this model still needs work. The saved version has one divergent transition. Refit!
# control = list(adapt_delta = 0.999,
#                      max_treedepth = 15), yielded one divergent transition (took about 6 hours to fit!)
...
set.seed(20)
crossing(farmer = str_c("farmer ", 1:4),
         x      = 0:2, 
         y      = 0:2) %>% 
  group_by(farmer) %>% 

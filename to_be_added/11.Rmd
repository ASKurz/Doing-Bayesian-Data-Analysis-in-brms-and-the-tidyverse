...
Instead we have to take many draws to take from $Poisson(24)$. Here's what it looks like when we take 10,000.
...
rm(h_counter, coins, n, z, n_choose_z, flips, highest_n, bernoulli_likelihood, trial_data, d_nail, d_coin, plot_1, plot_2, plot_3, hdi_of_icdf, theta, alpha_pc, c, z_maker, n_iter)
```

...
Looks like the model did a nice job recapturing the population parameters.
...
>
>$\mu = \alpha \cdot \frac{1}{2} + (1 - \alpha) \cdot \text{logistic} \bigg ( \beta_0  + \sum_j \beta_j x_j \bigg )$
>
...
Look at how that sweet HMC reduced the correlation between $\beta_0$ and $\beta_1$.
...
rm(my_data, p, fit1, length, n_iter, nd, f, thresholds, fit2, post, b0, b1, n, d_rare, fit3, d_not_rare, fit4, s, m, d, b2, fit5, different_seed, b3, fit6, fit7, logistic, positions)

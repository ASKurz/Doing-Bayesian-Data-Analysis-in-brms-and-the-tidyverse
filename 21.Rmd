...
Our first plot will explore the relations among the continuous variables `weight` and `height` and the dummy variable `male`. The `ggMarginal()` function from the [**ggExtra** package](https://github.com/daattali/ggExtra) [@R-ggExtra] will help us get a sense of the multivariate distribution by allowing us to add marginal densities to a scatter plot.
...
rm(my_data, pm, p, fit21.1, length, n_iter, nd, f, thresholds, stat_wilke, fit21.2, post, b0, b1, n, d_rare, fit21.3, d_not_rare, fit21.4, p1, p2, p3, s, m, d, b2, fit21.5, different_seed, my_upper, my_diag, my_lower, b3, fit21.6, fit21.7, logistic, positions, fit21.8)
```

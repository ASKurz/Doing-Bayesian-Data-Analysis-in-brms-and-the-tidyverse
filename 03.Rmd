...
To learn more, Jenny Bryan has a [great talk](https://www.youtube.com/watch?v=4MfUCX_KpdE&t=615s&frags=pl%2Cwn) discussing the role of lists within data wrangling. There's also this classic pic from Hadley Wickham: 

```{r echo = FALSE}
blogdown::shortcode('tweet', '643381054758363136')
```

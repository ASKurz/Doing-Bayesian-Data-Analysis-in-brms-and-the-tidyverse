This repository is the GitHub home for my **brms**/**tidyverse** translation of Kruschke's [*Doing Bayesian data analysis: A tutorial with R, JAGS, and Stan*](https://sites.google.com/site/doingbayesiandataanalysis/). You can find the current HTML version of my translation at [https://solomon.quarto.pub/dbda2/](https://solomon.quarto.pub/dbda2/).
...
* responding to requests for help either in the GitHub issues section (e.g., [here](https://github.com/ASKurz/Doing-Bayesian-Data-Analysis-in-brms-and-the-tidyverse/issues/22)) or in the ebook itself (e.g., in the middle of  [Section 11.1.4](https://solomon.quarto.pub/dbda2/11.html#with-intention-to-fix-duration)); or

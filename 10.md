...
```
    ...
    ## Warning: There were 102 divergent transitions after warmup. Increasing adapt_delta above 0.999 may help.
    ...
    ## Intercept     0.71      0.13     0.43     0.92       7243 1.00
    ## 
...
```
    ...
    ##   b_Intercept      lp__
    ## 1   0.7232882 1.1105138
    ## 2   0.7498553 1.1287150
    ## 3   0.7441883 1.1278240
    ## 4   0.8161284 0.9943963
    ## 5   0.7120822 1.0926519
    ## 6   0.7034136 1.0749485
...
```
    ...
    ## Intercept 0.7080327 0.1269554 0.4325314 0.9161209
...
![](10_files/figure-markdown_github/unnamed-chunk-36-1.png)
...
![](10_files/figure-markdown_github/unnamed-chunk-37-1.png)
...
```
    ...
    ## Warning in rm(length, p_d, p_d_1, p_d_2, d, p1, p2, bernoulli_likelihood, :
    ## object 'n' not found

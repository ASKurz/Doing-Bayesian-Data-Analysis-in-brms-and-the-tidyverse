...
* a small update to the geom default oriented code in @sec-Linear-function-of-a-single-metric-predictor; 
* adding comments sections (e.g., see [here](https://solomon.quarto.pub/dbda2/#comments)) via [giscus](https://giscus.app/);
* updating all model fits with **brms** version 2.23.0; and
...
```default
@book{kurzDoingBayesianDataAnalysis2026,

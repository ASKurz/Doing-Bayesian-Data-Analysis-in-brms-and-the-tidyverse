...
```{r}
draws_df <- as_draws_df(fit23.1)

glimpse(draws_df)
```

Wrangle `draws_df` a bit.
...
For this model, however, we will follow Kruschke and make a more faithful version of the top panel of Figure 23.9. We'll need to wrangle our `draws_df` data a bit to get things ready. Here's the work.

...
```{r, fig.width = 7, fig.height = 5.5, message = F}
# brackets
p1 <-
  tibble(x = .5,
         y = .5,
...
post %>% 
  ...
  stat_pointinterval(point_interval = mode_hdi, .width = .95, point_size = 6,

...
```{r 18_fit1, cache = T, message = F, warning = F}
fit1 <-
  brm(data = my_data,
      family = student,
...
```{r f18_it2, cache = T, message = F, warning = F}
fit2 <-
  brm(data = my_data,
      family = student,
...
```{r 18_fit3, cache = T, message = F, warning = F}
fit3 <-
  brm(data = my_data,
      family = student,
...
```{r 18_fit4, cache = T, message = F, warning = F, results = 'hide'}
fit4 <-
  update(fit1, 
         newdata = my_data,
...
```{r 18_fit5, cache = T, message = F, warning = F, results = 'hide'}
fit5 <-
  update(fit4, 
         newdata = my_data,
         formula = satt_z ~ 1 + prcnt_take_z + spend_z + x_rand_1 + x_rand_2 + x_rand_3 + x_rand_4 + x_rand_5 + x_rand_6 + x_rand_7 + x_rand_8 + x_rand_9 + x_rand_10 + x_rand_11 + x_rand_12,
...
```{r 18_fit6_7_and_8, cache = T, message = F, warning = F, results = 'hide'}
fit6 <-
  update(fit1,
...
```{r 18_fit9_through_12, cache = T, message = F, warning = F, results = "hide"}
fit9 <-
  update(fit1,
...
```{r 18_fit13_through_16, cache = T, message = F, warning = F, results = "hide"}
fit13 <-
  update(fit9,
...
```{r 18_fit_1111_through_0000, cache = T, message = F, warning = F, results = 'hide'}
fit_1111 <-
  brm(data = my_data,
      family = student,
